    ...
    <div class="hidden sm:flex fixed bottom-8 left-8 z-50 items-center group">
        <div class="relative flex items-center">
            ...
            <span class="absolute left-full ml-4 whitespace-nowrap px-3 py-1.5 bg-gray-900 text-white text-sm font-medium rounded-lg opacity-0 pointer-events-none transition-opacity group-hover:opacity-100 shadow-xl">ðŸ“ž Call Us: +91 84880 75196</span>
        </div>
    </div>
        ...
        (function () {
            ...
            var observer = new IntersectionObserver(function (entries) {
                entries.forEach(function (entry) {
                    ...
                    if (pageLoaded) {
                        injectMap(entry.target);          // Page already loaded â†’ inject now
                    } else {
                        mapsToLoad.push(entry.target);    // Page still loading â†’ queue it
                    }
                });
