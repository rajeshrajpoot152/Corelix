            ...
            <div class="relative lg:pb-16" data-aos="fade-left">
                ...
                <div class="mt-4 lg:mt-0 lg:absolute lg:bottom-0 lg:left-5 lg:right-5">
                    <div class="bg-white/95 backdrop-blur-md p-5 rounded-2xl border border-gray-200 shadow-xl">
                        <h3 class="text-xs font-black text-brand-blue mb-4 uppercase tracking-wider font-heading">Our Engineering Standards</h3>
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            <div class="bg-gray-50 rounded-xl p-3 border border-gray-100 group">
                                <h4 class="text-gray-900 font-bold font-heading text-sm mb-1 group-hover:text-brand-blue transition-colors">Lightning Fast Load</h4>
                                <p class="text-gray-500 text-xs leading-relaxed">Optimized architecture for instant speeds.</p>
                            </div>
                            <div class="bg-gray-50 rounded-xl p-3 border border-gray-100 group">
                                <h4 class="text-gray-900 font-bold font-heading text-sm mb-1 group-hover:text-brand-green transition-colors">Secure & Scalable</h4>
                                <p class="text-gray-500 text-xs leading-relaxed">Custom cloud foundations that never crash.</p>
                            </div>
                        </div>
                    </div>
                </div>
