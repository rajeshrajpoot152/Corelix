...
<section class="pt-28 pb-16 md:pt-36 md:pb-20 relative overflow-hidden bg-slate-950">
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center" data-aos="zoom-out-up">
        ...
        <p class="text-base md:text-xl text-gray-300 max-w-3xl mx-auto font-medium leading-relaxed mb-10">
            Rank higher and drive organic traffic with proven SEO strategies. From technical audits to local SEO, we turn search engines into your most powerful sales channel.
        </p>
    </div>
</section>
      ...
      <section id="services" class="py-20 md:py-28 bg-gray-50 border-b border-gray-200 relative overflow-hidden">
          ...
          <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
              <div class="text-center mb-14">
                  ...
                  <p class="text-gray-600 text-lg max-w-2xl mx-auto leading-relaxed">We combine deep technical auditing with superior content production and authoritative link building to definitively establish your brand as an industry leader.</p>
              </div>
      ...
      <section class="py-24 bg-slate-950 text-white relative overflow-hidden">
          ...
          <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
              <div class="text-center mb-16">
                  ...
                  <h2 class="text-4xl md:text-5xl font-black font-heading mb-6">Next-Generation SEO & Revenue Growth</h2>
                  <p class="text-slate-400 text-lg max-w-2xl mx-auto">Leveraging AI-driven optimization (GEO/AEO) to secure market dominance and maximize your ROI.</p>
              </div>
              ...
              <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                  <div class="bg-white/5 border border-white/10 p-6 rounded-3xl backdrop-blur-md hover:bg-white/10 transition-colors">
                      ...
                      <h3 class="text-xl font-bold font-heading mb-3">Accelerated Lead Generation</h3>
                      <p class="text-slate-400 text-sm leading-relaxed">We engineer traffic funnels that attract highly qualified prospects, significantly boosting your conversion rates.</p>
                  </div>
                  ...
                  <div class="bg-white/5 border border-white/10 p-6 rounded-3xl backdrop-blur-md hover:bg-white/10 transition-colors">
                      ...
                      <h3 class="text-xl font-bold font-heading mb-3">Scalable Revenue & Sales</h3>
                      <p class="text-slate-400 text-sm leading-relaxed">Turn organic visibility into a predictable revenue engine that scales effortlessly over time to maximize ROI.</p>
                  </div>
                  ...
                  <div class="bg-white/5 border border-white/10 p-6 rounded-3xl backdrop-blur-md hover:bg-white/10 transition-colors relative overflow-hidden">
                      ...
                      <h3 class="text-xl font-bold font-heading mb-3">AI & Generative Search (AEO)</h3>
                      <p class="text-slate-400 text-sm leading-relaxed">We future-proof your brand by optimizing for AI search engines, ensuring your content is cited by LLMs.</p>
                  </div>
                  ...
                  <div class="bg-white/5 border border-white/10 p-6 rounded-3xl backdrop-blur-md hover:bg-white/10 transition-colors">
                      ...
                      <h3 class="text-xl font-bold font-heading mb-3">Unmatched Brand Authority</h3>
                      <p class="text-slate-400 text-sm leading-relaxed">Build deep trust with your audience through authoritative content that sparks meaningful engagement.</p>
                  </div>
              </div>
          </div>
      </section>
...
<!-- 04. Our Workflow (Audit to Scale) -->
      <section class="py-24 bg-gray-50 border-b border-gray-200">
          <div class="container mx-auto px-4 sm:px-6 lg:px-8">
              <div class="text-center mb-16">
                  <h2 class="text-4xl md:text-5xl font-black text-slate-900 font-heading mb-6">Our Robust SEO Lifecycle</h2>
...
<!-- 05. Tech Stack & Integration Platforms -->
    <section class="py-20 bg-white">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-10">
                <h2 class="text-3xl font-bold text-slate-900 mb-4 font-heading">Enterprise-Grade SEO Tools</h2>
    ...
    <section class="py-24 bg-slate-950 text-white border-b border-slate-800 relative overflow-hidden">
        <div class="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.02)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.02)_1px,transparent_1px)] bg-[size:4rem_4rem]"></div>
        <div class="absolute top-0 right-0 w-[600px] h-[600px] bg-brand-green/10 rounded-full mix-blend-screen filter blur-[100px] pointer-events-none"></div>
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <div class="bg-white/5 border border-white/10 p-8 rounded-3xl backdrop-blur-md hover:bg-white/10 transition-colors duration-300">
                    <div class="text-brand-green font-bold tracking-widest uppercase text-xs mb-2">Logistics Enterprise</div>
                    <h3 class="text-2xl font-bold font-heading mb-4">Reduced overhead by 40% in 6 months</h3>
                    <p class="text-slate-400 text-sm mb-6 leading-relaxed">By implementing custom SEO workflows, we eliminated redundant manual entry and improved data accuracy across 3 global branches.</p>
                ...
                <div class="bg-white/5 border border-white/10 p-8 rounded-3xl backdrop-blur-md hover:bg-white/10 transition-colors duration-300">
                    <div class="text-brand-green font-bold tracking-widest uppercase text-xs mb-2">FinTech Startup</div>
                    <h3 class="text-2xl font-bold font-heading mb-4">Scaled user acquisition by 250%</h3>
                    <p class="text-slate-400 text-sm mb-6 leading-relaxed">Our comprehensive SEO architecture allowed the client to securely onboard thousands of users seamlessly without infrastructure breaks.</p>
                    <div class="flex gap-4">
                        <div>
            ...
            <div class="text-center mt-12">
                <a href="#contact" class="inline-flex items-center gap-2 text-white font-bold hover:text-brand-green transition-colors">Read full case studies &rarr;</a>
            </div>
        </div>
    </section>
      ...
      <section class="py-24 bg-white border-b border-gray-200">
          <div class="container mx-auto px-4 sm:px-6 lg:px-8">
              <div class="text-center mb-16">
                  <h2 class="text-3xl md:text-4xl font-black text-slate-900 font-heading mb-4">Engineered for Your Specific Industry</h2>
