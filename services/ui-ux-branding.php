...
<section class="py-24 bg-slate-950 text-white border-b border-slate-800 relative overflow-hidden">
    ...
    <div
        class="absolute top-0 right-0 w-[600px] h-[600px] bg-purple-500/10 rounded-full mix-blend-screen filter blur-[100px] pointer-events-none">
    </div>
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="grid md:grid-cols-2 gap-8">
            <div
                ...
                <div class="text-purple-600 font-bold tracking-widest uppercase text-xs mb-2">Logistics Enterprise</div>
            ...
            <div
                class="bg-white/5 border border-white/10 p-8 rounded-3xl backdrop-blur-md hover:bg-white/10 transition-colors duration-300">
                <div class="text-purple-600 font-bold tracking-widest uppercase text-xs mb-2">FinTech Startup</div>
        ...
        <div class="text-center mt-12">
            <a href="#contact"
                class="inline-flex items-center gap-2 text-white font-bold hover:text-purple-600 transition-colors">Read
