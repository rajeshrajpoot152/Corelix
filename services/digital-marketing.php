...
<section id="ppc-marketing" class="py-20 md:py-28 bg-gray-50 relative border-b border-gray-200/60 scroll-mt-24">
    <!-- Subtle Ambient Glow -->
        ...
        <div class="max-w-[1536px] mx-auto">
            <div class="flex flex-col md:flex-row md:items-start justify-between gap-8 mb-12">
                <div class="md:max-w-2xl">
                    <div class="inline-flex items-center gap-2 px-3.5 py-1.5 bg-brand-orange/10 border border-brand-orange/20 text-brand-orange rounded-full text-xs font-bold tracking-widest uppercase mb-4 shadow-sm">
                        SECTION 01
                    </div>
                ...
                <div class="md:col-span-5 md:border-l md:border-gray-200 md:pl-8 flex flex-col justify-between">
                    <div>
                        ...
                        <div class="flex flex-wrap gap-2 mb-8">
                            <span class="px-4 py-1.5 bg-white border border-gray-200 text-gray-700 shadow-sm shadow-sm transition-colors">Google Ads</span>
                            <span class="px-4 py-1.5 bg-white border border-gray-200 text-gray-700 shadow-sm shadow-sm transition-colors">Google Tag Manager</span>
                            <span class="px-4 py-1.5 bg-white border border-gray-200 text-gray-700 shadow-sm shadow-sm transition-colors">GA4</span>
                            <span class="px-4 py-1.5 bg-white border border-gray-200 text-gray-700 shadow-sm shadow-sm transition-colors">Looker Studio</span>
                            <span class="px-4 py-1.5 bg-white border border-gray-200 text-gray-700 shadow-sm shadow-sm transition-colors">Bing Ads</span>
                        </div>
                    </div>
...
<section id="cro" class="py-20 md:py-28 bg-white relative border-b border-gray-200/60 scroll-mt-24">
    <!-- Subtle Ambient Glow -->
    <div class="absolute top-0 right-0 w-96 h-96 bg-brand-blue/5 rounded-full mix-blend-screen filter blur-[100px] pointer-events-none"></div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-8 bg-gray-50 rounded-3xl p-8 md:p-10 border border-gray-100 shadow-xl">
                ...
                <div class="md:col-span-5 md:border-l md:border-gray-200 md:pl-8 flex flex-col justify-between">
                    <div>
                        ...
                        <div class="flex flex-wrap gap-2 mb-8">
                            <span class="px-4 py-1.5 bg-white border border-gray-200 text-gray-700 shadow-sm shadow-sm transition-colors">Hotjar</span>
                            <span class="px-4 py-1.5 bg-white border border-gray-200 text-gray-700 shadow-sm shadow-sm transition-colors">Microsoft Clarity</span>
                            <span class="px-4 py-1.5 bg-white border border-gray-200 text-gray-700 shadow-sm shadow-sm transition-colors">Optimizely</span>
                            <span class="px-4 py-1.5 bg-white border border-gray-200 text-gray-700 shadow-sm shadow-sm transition-colors">VWO</span>
                            <span class="px-4 py-1.5 bg-white border border-gray-200 text-gray-700 shadow-sm shadow-sm transition-colors">Google Optimize Alternative</span>
                        </div>
                    </div>
...
<section id="social-media" class="py-20 md:py-28 bg-gray-50 relative border-b border-gray-200/60 scroll-mt-24">
    <!-- Subtle Ambient Glow -->
    <div class="absolute top-0 right-0 w-96 h-96 bg-brand-blue/5 rounded-full mix-blend-screen filter blur-[100px] pointer-events-none"></div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-8 bg-white rounded-3xl p-8 md:p-10 border border-gray-100 shadow-xl">
                ...
                <div class="md:col-span-5 md:border-l md:border-gray-200 md:pl-8 flex flex-col justify-between">
                    <div>
                        ...
                        <div class="flex flex-wrap gap-2 mb-8">
                            <span class="px-4 py-1.5 bg-white border border-gray-200 text-gray-700 shadow-sm shadow-sm transition-colors">Meta Ads Manager</span>
                            <span class="px-4 py-1.5 bg-white border border-gray-200 text-gray-700 shadow-sm shadow-sm transition-colors">LinkedIn Campaign Manager</span>
                            <span class="px-4 py-1.5 bg-white border border-gray-200 text-gray-700 shadow-sm shadow-sm transition-colors">TikTok Ads</span>
                            <span class="px-4 py-1.5 bg-white border border-gray-200 text-gray-700 shadow-sm shadow-sm transition-colors">Canva</span>
                            <span class="px-4 py-1.5 bg-white border border-gray-200 text-gray-700 shadow-sm shadow-sm transition-colors">Social Analytics</span>
                        </div>
                    </div>
...
<section id="email-marketing" class="py-20 md:py-28 bg-white relative border-b border-gray-200/60 scroll-mt-24">
    <!-- Subtle Ambient Glow -->
    <div class="absolute top-0 right-0 w-96 h-96 bg-brand-blue/5 rounded-full mix-blend-screen filter blur-[100px] pointer-events-none"></div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-8 bg-gray-50 rounded-3xl p-8 md:p-10 border border-gray-100 shadow-xl">
                ...
                <div class="md:col-span-5 md:border-l md:border-gray-200 md:pl-8 flex flex-col justify-between">
                    <div>
                        ...
                        <div class="flex flex-wrap gap-2 mb-8">
                            <span class="px-4 py-1.5 bg-white border border-gray-200 text-gray-700 shadow-sm shadow-sm transition-colors">Klaviyo</span>
                            <span class="px-4 py-1.5 bg-white border border-gray-200 text-gray-700 shadow-sm shadow-sm transition-colors">HubSpot</span>
                            <span class="px-4 py-1.5 bg-white border border-gray-200 text-gray-700 shadow-sm shadow-sm transition-colors">Mailchimp</span>
                            <span class="px-4 py-1.5 bg-white border border-gray-200 text-gray-700 shadow-sm shadow-sm transition-colors">ActiveCampaign</span>
                            <span class="px-4 py-1.5 bg-white border border-gray-200 text-gray-700 shadow-sm shadow-sm transition-colors">CRM Automation</span>
                        </div>
                    </div>
