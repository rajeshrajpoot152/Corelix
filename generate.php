...
<section class=\"py-24 relative overflow-hidden bg-[#000000]\">
    <div class=\"max-w-4xl mx-auto px-4 text-center relative z-10\" data-aos=\"zoom-in\">
        ...
        <a href=\"/contact.php\" class=\"inline-flex items-center px-8 py-4 rounded-full bg-brand-blue text-white font-bold hover:bg-blue-700 transition-all shadow-[0_0_20px_rgba(30,58,138,0.4)]\" title=\"Corelix Link\">
            Get in Touch
