...
<!-- Contact Form & Info -->
<section class="py-16 md:py-24 relative bg-white">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-start">
            
            <!-- Contact Information (Left) -->
            <div class="lg:col-span-5 space-y-6 md:space-y-8" data-aos="fade-right">
                <div>
                    <h2 class="text-3xl md:text-4xl font-bold font-heading text-brand-black mb-4">Direct Contact</h2>
            ...
            <div class="lg:col-span-7" data-aos="fade-left">
                <div class="bg-white p-6 sm:p-8 md:p-12 rounded-3xl md:rounded-[40px] border border-gray-100 shadow-[0_20px_60px_rgba(0,0,0,0.06)] relative overflow-hidden">
                    <div class="absolute -top-32 -right-32 w-64 h-64 bg-brand-blue/10 rounded-full blur-[80px] pointer-events-none"></div>
                    ...
                    <form action="process_contact.php" method="POST" class="space-y-4 md:space-y-5 relative z-10">
                        ...
                        <div>
                            <div class="relative">
                                ...
                                <div class="absolute inset-y-0 right-4 md:right-5 flex items-center pointer-events-none text-gray-400">
