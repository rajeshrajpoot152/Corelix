...
<section id="services-stack" class="py-8 md:py-12 bg-white relative border-b border-gray-200">
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="flex flex-col gap-4 mb-10" data-aos="fade-up">
            ...
            <p class="relative z-10 text-gray-600 text-xl max-w-2xl">We build custom websites, smart applications, and AI-driven solutions that look premium, rank higher, and turn visitors into loyal customers. Scroll to explore our tech stack.</p>
        </div>
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-3xl mx-auto mb-16" data-aos="fade-up">
            ...
            <p class="text-lg md:text-xl text-gray-600 font-medium">
                We combine modern frameworks like Next.js and Node.js with AI-driven tools to build scalable, high-performance digital solutions in record time.
            </p>
        </div>
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 mb-10 md:mb-16">
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-6" data-aos="fade-up">
            <div class="max-w-3xl text-center md:text-left">
                <h2 class="text-3xl md:text-5xl font-black font-heading text-white mb-4 md:mb-5 tracking-tight leading-[1.1]">Industry-Specific Solutions</h2>
                <p class="text-gray-400 text-base md:text-xl font-medium max-w-2xl leading-relaxed mx-auto md:mx-0">From custom portals to on-demand platforms, we deliver tailored software solutions that fit your business model. Skip the long development cycles and get to market faster.</p>
            </div>
        ...
        <div class="swiper industrySwiper w-full h-[450px] md:h-[600px]">
            <div class="swiper-wrapper h-full">
                <div class="swiper-slide industry-slide group h-full rounded-xl md:rounded-2xl lg:rounded-3xl overflow-hidden relative bg-[#111]">
                    ...
                    <div class="absolute inset-0 bg-gradient-to-r from-black/90 via-black/40 to-transparent flex flex-col justify-center items-start text-left p-8 md:p-16 lg:p-24 z-20 swiper-slide-content">
                        <div class="w-full max-w-2xl">
                            <h3 class="text-2xl md:text-3xl lg:text-[40px] font-bold text-white mb-6 md:mb-8 font-heading leading-tight">"Secure patient portals, real-time telemedicine apps, and custom healthcare management systems for modern clinics."</h3>
                ...
                <div class="swiper-slide industry-slide group h-full rounded-xl md:rounded-2xl lg:rounded-3xl overflow-hidden relative bg-[#111]">
                    ...
                    <div class="absolute inset-0 bg-gradient-to-r from-black/90 via-black/40 to-transparent flex flex-col justify-center items-start text-left p-8 md:p-16 lg:p-24 z-20 swiper-slide-content">
                        <div class="w-full max-w-2xl">
                            <h3 class="text-2xl md:text-3xl lg:text-[40px] font-bold text-white mb-6 md:mb-8 font-heading leading-tight">"Scalable LMS and interactive eLearning portals designed to boost engagement and streamline modern education."</h3>
                ...
                <div class="swiper-slide industry-slide group h-full rounded-xl md:rounded-2xl lg:rounded-3xl overflow-hidden relative bg-[#111]">
                    ...
                    <div class="absolute inset-0 bg-gradient-to-r from-black/90 via-black/40 to-transparent flex flex-col justify-center items-start text-left p-8 md:p-16 lg:p-24 z-20 swiper-slide-content">
                        <div class="w-full max-w-2xl">
                            <h3 class="text-2xl md:text-3xl lg:text-[40px] font-bold text-white mb-6 md:mb-8 font-heading leading-tight">"Scalable community platforms, custom social networking apps, and dynamic engagement tools for active users."</h3>
                ...
                <div class="swiper-slide industry-slide group h-full rounded-xl md:rounded-2xl lg:rounded-3xl overflow-hidden relative bg-[#111]">
                    ...
                    <div class="absolute inset-0 bg-gradient-to-r from-black/90 via-black/40 to-transparent flex flex-col justify-center items-start text-left p-8 md:p-16 lg:p-24 z-20 swiper-slide-content">
                        <div class="w-full max-w-2xl">
                            <h3 class="text-2xl md:text-3xl lg:text-[40px] font-bold text-white mb-6 md:mb-8 font-heading leading-tight">"Smart industrial automation, custom ERP solutions, and scalable supply chain management for seamless operations."</h3>
                ...
                <div class="swiper-slide industry-slide group h-full rounded-xl md:rounded-2xl lg:rounded-3xl overflow-hidden relative bg-[#111]">
                    ...
                    <div class="absolute inset-0 bg-gradient-to-r from-black/90 via-black/40 to-transparent flex flex-col justify-center items-start text-left p-8 md:p-16 lg:p-24 z-20 swiper-slide-content">
                        <div class="w-full max-w-2xl">
                            <h3 class="text-2xl md:text-3xl lg:text-[40px] font-bold text-white mb-6 md:mb-8 font-heading leading-tight">"On-demand booking systems, smart salon management software, and seamless lifestyle applications for modern businesses."</h3>
 ...
 <section class="py-8 md:py-12 bg-white relative overflow-hidden" style="background-color: #ffffff;" id="our-process">
        <div class="max-w-[1280px] mx-auto px-4 sm:px-6 relative z-10">
                <div class="text-center mb-10 md:mb-24">
                        ...
                        <p class="text-gray-500 text-sm sm:text-base md:text-xl">Design. Build. Scale. Engineering intelligent platforms that drive measurable growth.</p>
                </div>
                <!-- The Cross Layout -->
                        ...
                        <div class="grid grid-cols-2 relative z-10">
                                ...
                                <div
                                        ...
                                        <p
                                                ...
                                                Engineered for high performance, seamless scalability, and robust security to future-proof your digital infrastructure.</p>
                                </div>
                                ...
                                <div
                                        ...
                                        <p
                                                class="text-gray-500 text-[9px] sm:text-[11px] md:text-[0.95rem] leading-snug md:leading-relaxed">
                                                Adapt quickly and launch faster. We use secure, iterative development cycles to deliver continuous value to your users.</p>
                                </div>
                                ...
                                <div
                                        ...
                                        <p
                                                class="text-gray-500 text-[9px] sm:text-[11px] md:text-[0.95rem] leading-snug md:leading-relaxed">
                                                Work directly with specialized developers and strategic experts fully committed to your project's success and timeline.</p>
                                </div>
                                <!-- Quadrant 4: Build -->
                                <div
                                        ...
                                        <p
                                                class="text-gray-500 text-[9px] sm:text-[11px] md:text-[0.95rem] leading-snug md:leading-relaxed">
                                                Gain total project visibility through real-time progress tracking, clear communication, and collaborative workflows.</p>
                                </div>
                        </div>
                </div>
        </div>
...
<section class="py-8 md:py-12 bg-white relative overflow-hidden">
    ...
    <div class="container mx-auto relative z-10 overflow-hidden">
        <div class="mb-12 md:mb-16 max-w-4xl px-4 sm:px-6 lg:px-8 text-center mx-auto" data-aos="fade-up">
            ...
            <p class="text-gray-500 text-lg leading-relaxed max-w-3xl mx-auto">We partner with top companies to engineer fast, secure, and scalable digital platforms.</p>
        </div>
