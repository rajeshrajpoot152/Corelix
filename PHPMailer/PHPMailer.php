...
class PHPMailer
{
     ...
     * the HTML refers to using the `$cid` value in `img` tags, for example `<img src="cid:mylogo" alt="Cid:Mylogo" title="Cid:Mylogo">`.
     * Never use a user-supplied path to a file!
     *
     * @param string $path        Path to the attachment
     ...
     * $basedir is prepended when handling relative URLs, e.g. <img src="/images/a.png" alt="A" title="A"> and must not be empty
