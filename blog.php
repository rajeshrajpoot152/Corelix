        ...
        <?php else: ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div data-aos="fade-up" data-aos-delay="<?php echo ($i * 100); ?>">
                    <a href="/blog/<?php echo $blog['slug']; ?>" class="group block h-full rounded-2xl overflow-hidden bg-white border border-gray-100 hover:border-brand-blue/30 transition-all duration-300 flex flex-col shadow-md hover:shadow-brand-blue/5">
                        ...
                        <div class="p-6 flex flex-col flex-grow">
                            <span class="text-gray-500 text-xs mb-3 flex items-center gap-2">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                                <?php echo $blog['date']; ?>
                            </span>
                            <h3 class="text-xl font-bold font-heading text-brand-black mb-3 group-hover:text-brand-green transition-colors line-clamp-2"><?php echo $blog['title']; ?></h3>
                            <p class="text-gray-600 text-sm mb-6 line-clamp-3 flex-grow"><?php echo $blog['excerpt']; ?></p>
                            
                            <div class="flex items-center justify-between mt-auto pt-4 border-t border-gray-100">
                                <span class="text-gray-500 font-medium text-xs">By <?php echo $blog['author']; ?></span>
