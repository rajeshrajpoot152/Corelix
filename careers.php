                ...
                <div class="text-center mb-10 relative z-10">
                    ...
                    <?php elseif (isset($_GET['status']) && $_GET['status'] == 'error'): ?>
                        <div class="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-xl mb-6 font-medium text-sm text-center relative z-20">
                            <?php 
                            if(isset($_GET['msg']) && $_GET['msg'] == 'file-too-large') echo 'Resume file is too large (Max 5MB).';
                            elseif(isset($_GET['msg']) && $_GET['msg'] == 'invalid-file') echo 'Invalid resume format. Only PDF, DOC, and DOCX are allowed.';
