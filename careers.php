...
<a href="#apply-form" class="bg-white p-5 sm:p-6 md:px-8 rounded-2xl border border-gray-100 shadow-[0_2px_10px_rgb(0,0,0,0.02)] hover:shadow-xl hover:border-brand-blue/30 transition-all duration-300 group flex flex-col lg:flex-row lg:items-center justify-between gap-5 lg:gap-8" title="Corelix Link">
    <div class="flex-1 min-w-0">
        ...
        <p class="text-sm text-gray-500 truncate">2+ Years Experience â€¢ B2B Sales, Lead Generation, Client Relations.</p>
    </div>
...
<a href="#apply-form" class="bg-white p-5 sm:p-6 md:px-8 rounded-2xl border border-gray-100 shadow-[0_2px_10px_rgb(0,0,0,0.02)] hover:shadow-xl hover:border-brand-blue/30 transition-all duration-300 group flex flex-col lg:flex-row lg:items-center justify-between gap-5 lg:gap-8" title="Corelix Link">
    <div class="flex-1 min-w-0">
        ...
        <p class="text-sm text-gray-500 truncate">1-3 Years Exp â€¢ UI/UX, Branding, Adobe Creative Suite, Figma.</p>
    </div>
...
<a href="#apply-form" class="bg-white p-5 sm:p-6 md:px-8 rounded-2xl border border-gray-100 shadow-[0_2px_10px_rgb(0,0,0,0.02)] hover:shadow-xl hover:border-brand-blue/30 transition-all duration-300 group flex flex-col lg:flex-row lg:items-center justify-between gap-5 lg:gap-8" title="Corelix Link">
    <div class="flex-1 min-w-0">
        ...
        <p class="text-sm text-gray-500 truncate">2-4 Years Exp â€¢ React, Node.js, MongoDB, scalable architecture.</p>
    </div>
...
<a href="#apply-form" class="bg-white p-5 sm:p-6 md:px-8 rounded-2xl border border-gray-100 shadow-[0_2px_10px_rgb(0,0,0,0.02)] hover:shadow-xl hover:border-brand-blue/30 transition-all duration-300 group flex flex-col lg:flex-row lg:items-center justify-between gap-5 lg:gap-8" title="Corelix Link">
    <div class="flex-1 min-w-0">
        ...
        <p class="text-sm text-gray-500 truncate">1-3 Years Exp â€¢ ReactJS, VueJS, TailwindCSS, pixel-perfect UI.</p>
    </div>
...
<a href="#apply-form" class="bg-white p-5 sm:p-6 md:px-8 rounded-2xl border border-gray-100 shadow-[0_2px_10px_rgb(0,0,0,0.02)] hover:shadow-xl hover:border-brand-blue/30 transition-all duration-300 group flex flex-col lg:flex-row lg:items-center justify-between gap-5 lg:gap-8" title="Corelix Link">
    <div class="flex-1 min-w-0">
        ...
        <p class="text-sm text-gray-500 truncate">Fresher â€¢ Off-page/On-page SEO, link building, keyword tracking.</p>
    </div>
...
<a href="#apply-form" class="bg-white p-5 sm:p-6 md:px-8 rounded-2xl border border-gray-100 shadow-[0_2px_10px_rgb(0,0,0,0.02)] hover:shadow-xl hover:border-brand-blue/30 transition-all duration-300 group flex flex-col lg:flex-row lg:items-center justify-between gap-5 lg:gap-8" title="Corelix Link">
    <div class="flex-1 min-w-0">
        ...
        <p class="text-sm text-gray-500 truncate">Students & Freshers â€¢ Flexible tasks, data entry, social media tasks.</p>
    </div>
...
<a href="#apply-form" class="bg-white p-5 sm:p-6 md:px-8 rounded-2xl border border-gray-100 shadow-[0_2px_10px_rgb(0,0,0,0.02)] hover:shadow-xl hover:border-brand-blue/30 transition-all duration-300 group flex flex-col lg:flex-row lg:items-center justify-between gap-5 lg:gap-8" title="Corelix Link">
    <div class="flex-1 min-w-0">
        ...
        <p class="text-sm text-gray-500 truncate">3+ Years Exp â€¢ IT Sales, Upwork/Fiverr/LinkedIn, Global Markets.</p>
    </div>
...
<a href="#apply-form" class="bg-white p-5 sm:p-6 md:px-8 rounded-2xl border border-gray-100 shadow-[0_2px_10px_rgb(0,0,0,0.02)] hover:shadow-xl hover:border-brand-blue/30 transition-all duration-300 group flex flex-col lg:flex-row lg:items-center justify-between gap-5 lg:gap-8" title="Corelix Link">
    <div class="flex-1 min-w-0">
        ...
        <p class="text-sm text-gray-500 truncate">1-4 Years Exp â€¢ Premiere Pro, After Effects, Motion Graphics.</p>
    </div>
...
<a href="#apply-form" class="bg-white p-5 sm:p-6 md:px-8 rounded-2xl border border-gray-100 shadow-[0_2px_10px_rgb(0,0,0,0.02)] hover:shadow-xl hover:border-brand-blue/30 transition-all duration-300 group flex flex-col lg:flex-row lg:items-center justify-between gap-5 lg:gap-8" title="Corelix Link">
    <div class="flex-1 min-w-0">
        ...
        <p class="text-sm text-gray-500 truncate">1â€“2 Years Exp â€¢ Proficient in HTML5, CSS3, JS & UI frameworks.</p>
    </div>
...
<?php include 'footer.php'; ?>
GET['msg'] == 'file-too-large') echo 'Resume file is too large (Max 5MB).';
                            elseif(isset(<?php 
$pageTitle = "Careers at Corelix | IT, Design & Marketing Job Openings";
$metaDesc = "Join Corelix! Explore remote and on-site job openings in Software Engineering, UI/UX Design, SEO, AI Engineering, and Digital Marketing. Build the future with us.";
$metaKeywords = "Corelix Careers, IT Jobs, Remote Tech Jobs, Software Engineering Careers, UI UX Design Jobs, Digital Marketing Jobs, Hiring IT Professionals";
...
<?php include 'footer.php'; ?>
GET['msg'] == 'invalid-file') echo 'Invalid resume format. Only PDF, DOC, and DOCX are allowed.';
                            else echo 'Oops! Something went wrong. Please check your inputs and try again.';
                            ?>
                        </div>
                    <?php endif; ?>
                    <form action="process_career.php" method="POST" enctype="multipart/form-data" class="space-y-4 sm:space-y-5 relative z-10">
