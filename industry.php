    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8" data-aos="fade-up">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            foreach ($industries as $sol) {
                echo '<a href="/contact" class="group relative flex items-center p-6 sm:p-8 bg-transparent rounded-2xl hover:bg-orange-50/50 transition-all duration-300">
                        <div class="w-12 h-12 flex items-center justify-center text-[#F97316] group-hover:scale-110 transition-transform duration-300 shrink-0">
                            <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">'.$sol['icon'].'</svg>
                        </div>
                        <div class="ml-6">
                            <h3 class="text-[17px] font-bold text-gray-700 group-hover:text-gray-900 transition-colors">'.$sol['name'].'</h3>
                        </div>
                      </a>';
            }
            ?>
