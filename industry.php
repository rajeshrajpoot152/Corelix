        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            $industries = [
                [
                    ...
                    'desc' => 'Custom IT solutions for Healthcare, telemedicine platforms, hospital management systems, and medical software development.'
                ],
                [
                    'title' => 'Legal',
                    ...
                    'desc' => 'High-end corporate websites, secure client communication portals, and document management systems for law firms.'
                ],
                [
                    'title' => 'Logistics',
                    ...
                    'desc' => 'Advanced real-time tracking apps, fleet management software, and custom ERP systems engineered for logistics.'
                ],
                [
                    'title' => 'Finance',
                    ...
                    'desc' => 'Secure enterprise portals, custom banking software, insurance platforms, and modern payment gateway integrations.'
                ],
                [
                    'title' => 'Education',
                ...
                [
                    ...
                    'desc' => 'Custom social networking platforms, highly scalable chat applications, and engaging community forums.'
                ],
                [
                    'title' => 'Media & OTT',
                ...
                [
                    ...
                    'desc' => 'Secure claims processing systems, insurtech mobile apps, and automated policy management software.'
                ],
                [
                    'title' => 'Travel',
                ...
                [
                    ...
                    'desc' => 'End-to-end custom eCommerce development, robust inventory management solutions, and omnichannel POS systems.'
                ],
                [
                    'title' => 'Manufacturing',
                    ...
                    'desc' => 'Industrial automation software, custom ERP solutions, and IoT integrations designed to streamline factory operations.'
                ],
                [
                    'title' => 'Construction',
                    ...
                    'desc' => 'Project management ERPs, on-site tracking software, and contractor bidding platforms for the construction industry.'
                ],
                [
                    ...
                    'desc' => 'Salon booking apps, augmented reality (AR) try-on solutions, and custom lifestyle eCommerce portals.'
                ],
                [
                    'title' => 'Sports',
                    ...
                    'desc' => 'Live scoring applications, fantasy sports platforms, and team management software with real-time analytics.'
                ],
                [
                    'title' => 'On Demand',
                    'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>',
                    'desc' => 'Food delivery apps, taxi booking solutions, and hyper-local service platforms built for speed and reliability.'
                ],
                [
                    'title' => 'Marketplace',
                    ...
                    'desc' => 'Multi-vendor marketplace development, B2B trading platforms, and seamless C2C auction websites.'
                ],
                [
                    'title' => 'IT & Telecom',
                    ...
                    'desc' => 'Network monitoring tools, billing software integrations, and robust VoIP communication platforms.'
                ],
                [
                    'title' => 'Automotive',
                ...
                [
                    ...
                    'desc' => 'Innovative property listing portals, virtual VR tours, and scalable Real Estate CRM systems.'
                ],
                [
                    'title' => 'Energy & Utilities',
                    'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M13 10V3L4 14h7v7l9-11h-7z"></path>',
                    'desc' => 'Smart grid monitoring software, renewable energy tracking dashboards, and utility billing solutions.'
                ],
            ];
