<?php 
$pageTitle = "Corporate Identity Design | Corelix";
$metaDesc = "Corelix provides premium Corporate Identity Design. Partner with our expert team for cutting-edge digital transformation and business growth.";
$metaKeywords = "Corporate Identity Design, Corelix Corporate Identity Design, Corporate Identity Design Agency, Best Corporate Identity Design, Corporate Identity Design Services";
?>
...
<section class="pt-28 pb-12 md:pt-32 md:pb-16 relative overflow-hidden bg-slate-950">
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center" data-aos="zoom-out-up">
        ...
        <h2 class="text-3xl md:text-5xl lg:text-6xl font-black font-heading text-white mb-4 tracking-tight leading-tight md:leading-none">
            Corporate Identity <span class="text-transparent bg-clip-text bg-gradient-to-r from-brand-blue to-brand-green">Design</span>
        </h2>
...
<section class="py-24 bg-white relative">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8" data-aos="fade-up">
        <div class="prose prose-lg max-w-none text-gray-600">
            <h2 class="text-3xl font-heading font-bold text-gray-900 mb-6">Transform Your Business with Corporate Identity Design</h2>
